...
# (WORKERS/BATCH) нақты production деректерімен өлшенді: 12/24-те де
# Juz40 API қатесіз жауап береді (110 оқушылы топ 88с-тан ~53с-қа дейін
# қысқарды), ескі 4/8 тым сақтық үшін төмен болған.
JUZ40_QUESTION_CHUNK_SIZE = 1
JUZ40_QUESTION_STUDENT_WORKERS = 12
JUZ40_QUESTION_STUDENT_BATCH = 24
