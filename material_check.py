...
from gdocs import fetch_doc_text, DocFetchError
...
# Vercel-дің бір сұраныс уақыты шегіне (60с) сыю үшін — тексеру қадамы бетті
# оқудан жеңілірек (мәтінмен салыстыру, PDF vision емес), сол себепті
# кітапты оқудағыдан үлкенірек топпен алса болады.
PAGES_PER_BATCH = 5
